...
#define ENCODER_MULTIPLE_RATIO          5
...
#define ENCODER_EXTI_DISABLE()   HAL_NVIC_DisableIRQ(TIM6_DAC_IRQn)
#define ENCODER_EXTI_ENABLE()    HAL_NVIC_EnableIRQ(TIM6_DAC_IRQn)
#define ENCODER_EXTI_FLAG_CLEAR()     __HAL_GPIO_EXTI_CLEAR_FLAG(TIM6_DAC_IRQn)
#define ENCODER_EXTI_FLAG_SET()         __HAL_GPIO_EXTI_SET_FLAG(TIM6_DAC_IRQn)
